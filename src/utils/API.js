...
const posts = [
    ...
    },
    {
        ...
        copy: "Just found out about the browser's native speech recognition API through today's JavaScript 30 challenge. It's not perfect but it would be fun to create a small app with it. Here's a video of me testing it out and reading some quotes from the X-Men movies:",
    ...
    },
    {
        ...
        copy: "The JavaScript 30 challenge for today was to sort a list of band names while ignoring the articles: the, a, and an. I attempted the challenge on my own before following along the instructor's solution. I converted each of the name into an array to detect whether or not the first string would be an article. From there I would compare them based on the first non-article string. My solution took a lot more lines of codes and my way of rendering it to the DOM was different from that of the instructor's, but I was still able to solve it on my own. However, I do prefer the instructor's solution.",
